...
var oneway_config = {late: 50, rank: {TITLE: {G1: "较可靠,推荐购买", G2: "较可靠,推荐购买", G3: "可能过期,谨慎购买", G4: "需申请,谨慎购买", G5: "供参考,可尝试购买"}, GTITLE: {AD_G1: ["", "", "", ""], AD_G2: ["", "", "", ""], AD_G3: ["可能过期", "可能过期", "可能过期", "可能过期"], AD_G4: ["需申请", "需申请", "需申请", "需申请"], AD_G5: ["仅供参考", "仅供参考", "仅供参考", "仅供参考"], nonAD_G1: ["", "", "", ""], nonAD_G2: ["", "", "", ""], nonAD_G3: ["可能过期", "可能过期", "可能过期", "可能过期"], nonAD_G4: ["需申请", "需申请", "需申请", "需申请"], nonAD_G5: ["仅供参考", "仅供参考", "仅供参考", "仅供参考"]}}, PayCarrierList: {CA: true, CZ: true, "8L": true, SC: true, JD: true, PN: true, GS: true, HU: true, MU: true, ZH: true, "3U": true}, PayCarrierSort: {HU: [], "3U": [], GS: [], MF: [], "8L": [], PN: [], MU: [], HO: [], JD: [], JR: [], BK: [], CA: [], SC: [], ZH: [], CZ: [], TV: []}, StrikingCarrier: {"9C": 100}, NonStrikingCarrier: {CA: 20, CZ: 20, HU: 20, SC: 20, JD: 20, PN: 20, MU: 20, "3U": 20, ZH: 20}, NoNeedStatementList: ["9C"], SpecialRecommend: {price: 200}, DefaultTax: {FUEL: 0, ACF: 50}, SpringHotConfig: {springDate: new Date("2009/01/26"), startShowDate: new Date("2008/10/01"), endShowDate: new Date("2009/03/20"), roundtripspringStartDate: new Date("2009/01/11"), springStartDate: new Date("2009/01/11"), springEndDate: new Date("2009/02/19")}, OnewayListShareConfig: {shareCodeNum: 8, mainCodeNum: 6, showornotshow: {}}, CuxiaoConfig: {gnd0907cxcp: {name: "川航促销专区", text: "直减10元"}, gndcphnair2: {name: "海航促销专区", text: "后返10元"}}};
...
var $jex = {ie: 0, gecko: 0, opera: 0, safari: 0, isdebug: false, testurl: (window.location.search.indexOf("&testurl") > 0), browser: null, mobile: null, air: null, VOIDFUNC: function () {
}, globalID: (function () {
    var a = 0;
    return function () {
        return a++;
    };
})(), _innerClass: {}, register: function (b, a) {
    $jex._innerClass[b] = a;
}, getClass: function (a) {
...
}, $continue: new Object(), $break: new Object(), foreach: function (b, g) {
    var a = null;
    if (b instanceof Array) {
...
$jex.exec(function () {
    ...
    var bindingEvent = {keypress: function (object, target, eventname, handler) {
...
(function () {
    ...
    $jex.merge($jex.event, {_readyList: [], _isReady: false, _bindReady: function () {
    ...
    $jex.merge($jex.date = {}, {_prefix: function (c, d) {
        d = d || 2;
        c = c + "";
        while (c.length < d) {
            c = "0" + c;
    ...
    $jex.merge($jex.web = {}, {parseQueryString: function (f) {
        var d = /([^\?|\&]\w+)=([^\?|\&]+)/ig;
        var c = {};
        if (f) {
            if (f.charAt(0) == "?") {
...
(function () {
    $jex.lightbox = {overlay: null, content: null, a: {display: "none", left: "0"}, b: {display: "none"}, c: {display: "block", left: "50%"}, d: {display: "block"}, binded: false, toBind: function () {
        $jex.lightbox.show(null, null, 1);
    }, cache: {}, gid: 1, expand: "lightbox_temp", removeData: function (c) {
        var f = c[this.expand];
        if (!f) {
            return;
        }
        ...
        if (c & 2) {
            ...
            $jex.hash.each($jex.extend({}, this.c, {top: ((f > 0 ? f : 0) + (window.pageYOffset || g.scrollTop)) + "px", marginLeft: 0 - d + "px"}), function (i, h) {
                $jex.lightbox.content.style[i] = h;
            });
        }
        if (c & 1) {
            $jex.hash.each($jex.extend({}, this.d, {height: Math.max(g.scrollHeight, g.clientHeight) + "px", width: Math.max(g.scrollWidth, g.clientWidth) + "px"}), function (i, h) {
...
$jex.hover = function (z) {
    var y = z.delay || 100, x = z.isover || !1, w = z.act, u = z.extra || [], t = null, s = function (b) {
...
var PriceUtil = {getOneWayDiscount: function (a) {
...
var FlightUtil = {codePatch: function (d) {
    var b = 1;
    var f = "";
...
var QunarDate = $jex.exec(function () {
    var b = {"2013-01-01": {afterTime: 3, beforeTime: 3, dayindex: 0, holidayName: "元旦"}, "2013-02-09": {afterTime: 0, beforeTime: 0, dayindex: 0, holidayName: "除夕"}, "2013-02-10": {afterTime: 6, beforeTime: 0, dayindex: 0, holidayName: "春节"}, "2013-02-24": {afterTime: 3, beforeTime: 3, dayindex: 0, holidayName: "元宵"}, "2013-04-04": {afterTime: 3, beforeTime: 3, dayindex: 0, holidayName: "清明"}, "2013-05-01": {afterTime: 3, beforeTime: 3, dayindex: 0, holidayName: "五一"}, "2013-06-12": {afterTime: 3, beforeTime: 3, dayindex: 0, holidayName: "端午"}, "2013-09-19": {afterTime: 3, beforeTime: 3, dayindex: 0, holidayName: "中秋"}, "2013-10-01": {afterTime: 3, beforeTime: 3, dayindex: 0, holidayName: "国庆"}, "2013-12-25": {afterTime: 3, beforeTime: 3, dayindex: 0, holidayName: "圣诞"}, "2014-01-01": {afterTime: 3, beforeTime: 3, dayindex: 0, holidayName: "元旦"}};
    var f = ["今天", "明天", "后天"];
    var i = 24 * 60 * 60 * 1000;
    var h = ["日", "一", "二", "三", "四", "五", "六"];
    ...
    var a = null;
    var d = null;
    return{getTimeRange: function (k) {
...
FlashAdUI.config = {systembusy: {info1: "<span class='textRed'>此ip操作过于频繁，请稍后再来。</span>", info2: "搜索结束", img: "http://source.qunar.com/site/images/no_loading.gif"}, searching: {info1: "请稍等,您查询的结果正在实时搜索中...", info2: "想去哪儿就去哪儿", img: "http://source.qunar.com/site/images/loading.gif"}, noResult: {info1: "<span class='textRed'>该航线当前无可售航班<br />请您尝试其他航线或日期</span>", info2: "搜索结束", img: "http://source.qunar.com/site/images/no_loading.gif"}, inValidQuery: {info1: "<span class='textRed'>抱歉，无直达航班，正试图搜索联程航班。</span>", info2: "想去哪儿就去哪儿", img: "http://source.qunar.com/site/images/loading.gif"}, sameCity: {info1: "<span class='textRed'>噢噢~Orz 原地打转的话搜不到结果哦！<br />请立即输入目的地城市，想去哪儿就去哪儿！<br />--Qunar 员工语录!<br /><b>您输入出发城市与到达城市相同，请至少修改其中之一。</b></span>", info2: "", img: "http://source.qunar.com/site/images/no_loading.gif"}, internopack: {info1: "<span class='textRed' style='text-align:left;'><b>没有找到您所查询的航班，可能原因如下：</b><br>1、您所查询的航线在“去哪儿”暂无往返报价，<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;可以更改为查询单程报价，也期待您联系<br />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;010-57603866，协助我们补充航班信息。<br />2、网络暂时繁忙。</span>", info2: "", img: "http://source.qunar.com/site/images/no_loading.gif"}};
...
var LoginControl = {isLogin: false, user: {name: ""}, checkLogin: function () {
    $jex.cookie.reset();
    ...
    QNR.crossDomainPost(b, {username: d, password: a, remember: 1}, "site/proxy.htm", {onsuccess: function (f) {
        if (f == 0) {
            c(true);
...
WrapperEntity.prototype._booking_url = function (b, c) {
    var a = {full: "false", codeBase: this.wrapperId(), codeName: this.vendor().codeName(), required2: this.ownerFlight().deptDate(), appendword0: this.ownerFlight().code(), fk: this.dataSource().fk ? 1 : 0, queryID: this.commInfoMgr().service().queryId(), updatetime: this.dataSource().ut, inter: "false", departureTime: this.ownerFlight().deptTime(), arrivalTime: this.ownerFlight().arriTime(), retailPrice: this.dataSource().pr, ccn: this.getVpr()};
...
WrapperUI.prototype.jumpToBooking = function (d, c, a) {
    ...
    d.booking(this.stat, {prt: b, tag: a, retailPrice: b == 1 ? d.afeePrice() : d.bprPrice()});
};
...
var HotSale = (function () {
    var b = {ps: "航班票量较少", hot: "一周内热门预订", lcc: "廉价航空公司不提供免费餐饮，免费携带的行李额度低，<br />详情咨询春秋航空：021-95524"};
    var d = -1, a = 100;
    var c = function (g, f) {
        var h = f.rate || 100;
        f.late = (h <= a && h < d);
...
BookingLockScreenUI.prototype.preBooking = function (f, a) {
    this.bFunc = f;
    this._vpr = 0;
    var d = this.entity, c = (a === 1 && d.afeePrice()) ? d.afeePrice() : d.bprPrice(), g = typeof d.ownerFlight().priceInfo == "function" ? d.ownerFlight().priceInfo() : null;
...
BookingLockScreenUI.prototype.getMsgInfo = function (c) {
    var f = this._vpr || 0;
    var g = {app: {txt: "您所选购的是特殊机票产品，机票需要申请，申请成功后将短信通知您。"}, transfer: {txt: ['您预订的是中转联程票，请确定各段价格都有效再付款。为了保证您的权益请阅读<a href="http://www.qunar.com/site/zh/Multi-city.shtml?', new Date().getTime(), '" target="_blank">《中转联程票购买须知》</a>。'].join("")}};
    var b = g[c], a = /app/.test(c), d = /transfer/.test(c);
...
OnewayFlightUI.prototype.update = function (a) {
    ...
    this.onInit(function () {
        $jex.hover({act: this.find("itemBar"), onmouseover: function (c) {
...
OnewayFlightUI.prototype.insert_recommandWrapper = function (c) {
    ...
    var b = this.reWrCache, g = c.getRecommandWrapper() || b;
    if (!g) {
        this.text("&nbsp;");
        return;
    }
    this.reWrCache = g;
    var d = g.entity, f = d.afeePrice() || d.bprPrice(), h = d.dataSource();
...
OnewayFlightWrapperListUI.prototype.insert_footer = function (b) {
    ...
    var c = b.getLowpr(f), d = b.getHipr(f);
    var i = b.getWrlen(f), h = 0, a;
    var g = b.wrappers();
    if (g.wrapperLength) {
        h = g.wrapperLength();
...
OnewayFlightWrapperListUI.prototype.getWrapperFormEntity = function (c) {
    ...
    c.getCurWrapperList({isUserClick: g, isMainFlight: this.isMainFlight(), loading: function () {
        d = (new Date()).valueOf();
...
OnewayFlightWrapperUI.prototype.update = function (g) {
    ...
    var f = this.ownerListUI().zIndex, a = this.ownerListUI().firstIndex;
...
OnewayFlightWrapperUI.prototype._bindHoverEvent = function (b) {
    ...
    this.onInit(function () {
        ...
        $jex.hover({act: c, onmouseover: function (d) {
...
OnewayFlightWrapperUI.prototype._bindOnInitEvent = function (b) {
    ...
    this.onInit(function () {
        ...
        function g() {
            ...
            $jex.jsonp(i, {flightNum: l.flightInfo().co, deptAirport: l.deptAirport().code, arrAirport: l.arriAirport().code, deptDate: l.deptDate().replace(/-/g, ""), printPrice: a.parValue(), wrapperId: a.wrapperId(), cabin: a.cabin(), policyId: a.pid(), maxSellPrice: Math.max(a.afeePrice(), a.bprPrice()), minSellPrice: Math.min(a.afeePrice() || Number.MAX_VALUE, a.bprPrice() || Number.MAX_VALUE)}, function (s) {
                f.loadedTgq = true;
                if (!s || (s && !s.msg)) {
            ...
            }, {timeout: {time: 2000, func: function () {
                if (!j) {
                    k.innerHTML = f.backTgq;
                }
            }}});
        ...
        if (d) {
            ...
            $jex.hover({act: d, extra: [this.find("tgq_notice_panel")], onmouseover: function (i) {
                if (c) {
                    return;
                }
...
OnewayFlightWrapperUI.prototype.priceHTML = function (a) {
    this.text('<div class="t_prc">' + Price_html.getHTML(a) + '<i class="rmb">&yen;</i></div>');
};
OnewayFlightWrapperUI.prototype.insert_PRICE_NORMAL = function (c) {
    var d = c.afeePrice(), a = c.bprPrice();
    d = parseInt(d);
    a = parseInt(a);
...
FlightInfoExtBarUI.prototype.update = function (b) {
    ...
    this.onInit(function () {
        ...
        var j = new XSelect({elemId: "hdivSort", initFire: false, values: [
            {value: "defalut", name: "默认排序", selected: k},
            {value: "priceDesc", name: "价格由低到高", selected: m},
            {value: "priceAsc", name: "价格由高到低", selected: f}
        ], on: {changeValue: function (n) {
...
BookingScreenUI.adjustOption = {allBusy: false, allNoWork: false, isTimeRange: function () {
    return false;
...
StarRankUI.prototype.displayPanel = function (c) {
    ...
    d.onInit(function () {
        ...
        var h = d.find("agent");
        var g = true;
        $jex.hover({act: f, onmouseover: function (i) {
            if (g) {
...
var FlightEventProxy = (function () {
    ...
    a.prototype = {clickDo: function (g, f) {
...
OTABlade.prototype = {extract: function (a) {
...
OTAInfoExtractor.prototype = {result: function () {
...
OnewayOTAInfoExtractor.prototype = $jex.merge({extract: function (a) {
}}, OTAInfoExtractor);
function RoundtripOTAInfoExtractor() {
    OTAInfoExtractor.call(this);
}
RoundtripOTAInfoExtractor.prototype = $jex.merge({extract: function (a) {
}}, OTAInfoExtractor);
...
OTAFlight.prototype = {key: function () {
    return this.keycode;
...
OTAWrapper.prototype.createBookingUrl = function (d, c, b) {
    var a = {full: "false", codeBase: this.info.wrid, codeName: this.info.cname, required2: this.flight.outFi().dd, appendword0: this.flight.outFi().co, fk: 0, queryID: d, updatetime: this.info.ut, inter: "false", departureTime: this.flight.outFi().dt, arrivalTime: this.flight.outFi().at, retailPrice: this.info.pr};
...
OTAGroup.prototype = {WRAPPER_URL: "/twell/flight/flight_ad.jsp", CARRIER_COUNT_SETTING: {"0": {"0": 0, "1": 1, "2": 4, "3": 5}, "1": {"0": 0, "1": 0, "2": 2, "3": 8}, "2": {"0": 0, "1": 0, "2": 0, "3": 10}, "3": {"0": 0, "1": 0, "2": 0, "3": 0}, "default": {"0": 2, "1": 2, "2": 3, "3": 3}}, options: function (b) {
    for (var a in b) {
    ...
    return this._wrappers_info || {codemap: {}, codelist: []};
...
var $OTALOGIC = (function () {
    return{vatafrom: "", vatato: "", departureTime: "", arrivalTime: "", track: function () {
...
recommendedHotels.show = function (q, t, w) {
    ...
    if (O) {
        ...
        var a = p.process({city: decodeURIComponent(B), city_url: q, hotelinfos: t, from: z, qtype: I, fromDate: u, toCity: recommendedHotels.city});
...
(function (Z) {
    ...
    T.prototype = {constructor: T, createCall: function (an) {
        var ao = this;
    ...
    QNR.AD = {version: "4.4", _AD: {}, _DE: {}, run_in_content: m, run_queue_list: function () {
        var an = "ad_queue_all";
        var ap = H[an];
        var ao = ap && ap.join("") || "";
        if (ao) {
        ...
        p();
        P();
    }, writeHeadScript: O, create_div_container: ak, writeContent: l, $inject_flash: J, createAdFrame: ab, createQAd: ad, add_AD_iframe: function (an, ap, ao) {
        if (!ap) {
            return;
        }
        if (ao) {
    ...
    }, callBackQDE: P, change_one_async: function () {
        var an = x;
        an.type = 1;
        QNR.AD.init(an);
        p();
...
var QadAdUnits = (function () {
    ...
    return{$E: d, append_style: c, renderTextLinkHTML: b, appendTextCss: h, parse_clk_url: f, create_iframe_hander: function (j, k) {
        if (typeof j === "string") {
...
(function () {
    ...
    function d(s, l, n) {
        ...
        var o = ['<div class="bannerTK_cont" id="result">'], q = n.key_data, t, j;
...
function FlightCityXCombox(c, d, b) {
    ...
    var a = this;
    this.setting = b || {};
    var f = new ScriptRequest({oncomplete: function (h) {
        a.suggLoaded(h);
    }, callbackName: "callback"});
    FlightCityXCombox.superclass.constructor.call(this, c, {button: {mousedown: function (h) {
        this.openMainMenu();
        $jex.stopEvent(h);
    }}, input: {change: function (k, i, j) {
        if (!j) {
            this.vidx = -1;
            this.inputold = k;
            k = k.replace(/[~!@#\$%\^&\*\(\)_\+<>\?:\\\\"\|\{\}`,\.\/;'\\\{\}]+/ig, "");
    ...
    }, popups: {main: {initialize: function () {
        ...
        for (var n = 0; n < p.length; n++) {
            ...
            h.push({tabID: j, tabname: p[n], render: o(p[n])});
        ...
        k.write(this.panel);
        var l = new TabGroup({panelContainerID: q, items: h});
...
function DatePickerXCombox(f, g, d) {
    ...
    DatePickerXCombox.superclass.constructor.call(this, f, {button: {mousedown: function (i) {
        this.openMainMenu();
        $jex.stopEvent(i);
...
var _tabConfig = {"热门": {cityList: [
    ...
    {name: "太原", country: "中国"},
    {name: "兰州", country: "中国"}
], title: "热门城市", desc: "可直接输入城市或城市拼音"}, "A-G": {cityList: [
    {name: "安庆", country: "中国"},
    {name: "阿勒泰", country: "中国"},
    {name: "安康", country: "中国"},
    {name: "阿克苏", country: "中国"},
    ...
    {name: "赣州", country: "中国"},
    {name: "格尔木", country: "中国"}
], title: "拼音A-G城市", desc: "可直接输入城市或城市拼音"}, "H-L": {cityList: [
    ...
    {name: "临沧", country: "中国"},
    {name: "临沂", country: "中国"}
], title: "拼音H-L城市", desc: "可直接输入城市或城市拼音"}, "M-T": {cityList: [
    {name: "牡丹江", country: "中国"},
    {name: "芒市", country: "中国"},
    {name: "满洲里", country: "中国"},
    {name: "绵阳", country: "中国"},
    ...
    {name: "通辽", country: "中国"},
    {name: "太原", country: "中国"}
], title: "拼音M-T城市", desc: "可直接输入城市或城市拼音"}, "W-Z": {cityList: [
    {name: "威海", country: "中国"},
    {name: "武汉", country: "中国"},
    {name: "梧州", country: "中国"},
    {name: "文山", country: "中国"},
    ...
    {name: "芷江", country: "中国"},
    {name: "湛江", country: "中国"}
], title: "拼音W-Z城市", desc: "可直接输入城市或城市拼音"}, "国际·港澳台": {cityList: [
    ...
    {name: "名古屋", country: "日本"}
], title: "热门国际·港澳台城市", desc: "可直接输入城市或城市拼音", cls: "inter"}, "热门城市1-30": {cityList: [
    {name: "香港", country: "中国香港"},
    {name: "新加坡", country: "新加坡"},
    {name: "首尔", country: "韩国"},
    {name: "曼谷", country: "泰国"},
    ...
    {name: "雅加达", country: "印度尼西亚"},
    {name: "名古屋", country: "日本"}
], title: "热门城市1-30", desc: "可直接输入城市或城市拼音", cls: "inter"}, "热门城市31-60": {cityList: [
    ...
    {name: "宿务", country: "西班牙"},
    {name: "开罗", country: "埃及"},
    {name: "阿德莱德", country: "澳大利亚"},
    {name: "札幌", country: "日本"},
    {name: "波士顿", country: "美国"},
    {name: "斯德哥尔摩", country: "瑞典"},
    {name: "珀斯", country: "澳大利亚"},
    {name: "伊斯坦布尔", country: "土耳其"},
    {name: "雅典", country: "希腊"}
], title: "热门城市31-60", desc: "可直接输入城市或城市拼音", cls: "inter"}, "亚洲/大洋洲": {cityList: [
    {name: "香港", country: "中国香港"},
    {name: "新加坡", country: "新加坡"},
    {name: "首尔", country: "韩国"},
    {name: "曼谷", country: "泰国"},
...
], title: "非洲热门城市", desc: "可直接输入中文名/拼音/英文名/三字码", cls: "inter"}, "热门城市": {cityList: [
    {name: "香港", country: "中国香港"},
    {name: "新加坡", country: "新加坡"},
    {name: "首尔", country: "韩国"},
    {name: "曼谷", country: "泰国"},
...
], title: "热门城市", desc: "可直接输入中文名/拼音/英文名/三字码", cls: "inter"}, "热门城市61-90": {cityList: [
    {name: "巴塞罗那", country: "西班牙"},
    {name: "仰光", country: "缅甸"},
    {name: "兰卡威", country: "马来西亚"},
    {name: "苏黎世", country: "瑞士"},
    {name: "蒙特利尔", country: "加拿大"},
    {name: "哥本哈根", country: "丹麦"},
    {name: "底特律", country: "美国"},
    ...
    {name: "塞班", country: "美国"},
    {name: "火奴鲁鲁", country: "美国"},
    {name: "丁加奴", country: "马来西亚"},
    {name: "孟买", country: "印度"},
    {name: "万象", country: "老挝"},
    {name: "休斯敦", country: "美国"},
    {name: "仙台", country: "日本"},
    {name: "曼彻斯特", country: "英国"},
    {name: "赫尔辛基", country: "芬兰"},
    {name: "日内瓦", country: "瑞士"},
    {name: "台中-清泉岗", country: "中国台湾"},
    {name: "清迈", country: "泰国"},
    {name: "科伦坡", country: "斯里兰卡"},
    {name: "杜塞尔多夫", country: "德国"},
    {name: "圣彼得堡", country: "俄罗斯"},
    {name: "达拉斯", country: "美国"},
    {name: "哥打巴鲁", country: "马来西亚"},
    {name: "拉斯维加斯", country: "美国"}
], title: "热门城市61-90", desc: "可直接输入城市或城市拼音", cls: "inter"}, "国内": {cityList: [
    {name: "上海", country: "中国"},
    {name: "北京", country: "中国"},
    {name: "广州", country: "中国"},
    {name: "昆明", country: "中国"},
    ...
    {name: "太原", country: "中国"},
    {name: "兰州", country: "中国"}
], title: "热门城市", desc: "可直接输入中文名/拼音/英文名/三字码", cls: "inter"}};
var FlightLang = {hotCityConfig: {domestic: {tabs: ["热门", "A-G", "H-L", "M-T", "W-Z", "国际·港澳台"], contents: {"热门": _tabConfig["热门"], "A-G": _tabConfig["A-G"], "H-L": _tabConfig["H-L"], "M-T": _tabConfig["M-T"], "W-Z": _tabConfig["W-Z"], "国际·港澳台": _tabConfig["国际·港澳台"]}}, "international-from": {tabs: ["热门", "A-G", "H-L", "M-T", "W-Z", "国际·港澳台"], contents: {"热门": _tabConfig["热门"], "A-G": _tabConfig["A-G"], "H-L": _tabConfig["H-L"], "M-T": _tabConfig["M-T"], "W-Z": _tabConfig["W-Z"], "国际·港澳台": _tabConfig["国际·港澳台"]}}, "international-to": {tabs: ["热门", "亚洲/大洋洲", "美洲", "欧洲", "非洲", "国内"], contents: {"热门": _tabConfig["热门城市"], "亚洲/大洋洲": _tabConfig["亚洲/大洋洲"], "美洲": _tabConfig["美洲"], "欧洲": _tabConfig["欧洲"], "非洲": _tabConfig["非洲"], "国内": _tabConfig["国内"]}}}, _CAPTIAL: "北京", _COUNTRY: "中国", _blankInput: "城市名"};
function SearchBox(a) {
    ...
    $jex.foreach(["fromCity", "toCity"], function (y, x) {
        b[y] = new FlightCityXCombox(a[y], b, {errorSuggestTip: "请输入正确的" + (x ? "到达" : "出发") + "城市"});
    ...
    var i = this.fromDate = new DatePickerXCombox(a.fromDate, b, {dateChecker: p});
    var s = this.toDate = new DatePickerXCombox(a.toDate, b, {dateChecker: p, fromDateBox: i});
    ...
    var o = {roundtrip: "searchTypeRnd", oneway: "searchTypeSng", deal: "searchTypeDeals"};
    ...
    var c = {memories: {fromCity: {value: function () {
        return d.getValue();
    }}, toCity: {value: function () {
        return n.getValue();
    }}, toDate: {value: function () {
        return s.getValue();
    }}, fromDate: {value: function () {
        return i.getValue();
    }}}};
...
var SearchBoxCreate = (function () {
    ...
    function b(j) {
        ...
        if (h) {
            var i = h.getElementsByTagName("button"), g = h.getElementsByTagName("b");
